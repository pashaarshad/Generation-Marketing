...
<head>
    ...
    <title><?php echo $blog ? htmlspecialchars($blog['title']) . " | Generation Marketing" : "Blog Not Found | Generation Marketing"; ?></title>
    <meta name="description" content="<?php echo $blog ? htmlspecialchars($blog['excerpt']) : "Blog post not found on Generation Marketing."; ?>">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom scrolled" style="background: white !important; box-shadow: 0 4px 15px rgba(0,0,0,0.05) !important; padding: 10px 0 !important;">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img src="assets/logo.png" alt="Generation Marketing" style="max-height: 45px;"></a>
            <a href="index.php#blog" class="nav-link text-dark ms-auto d-flex align-items-center gap-2" style="color: var(--navy) !important; font-weight: 600; text-decoration: none;">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mt-5 pt-4 border-top">
                            <a href="index.php#contact" class="btn-glow text-white text-decoration-none px-5 py-3 rounded-pill d-inline-block">
                    ...
                    <div class="col-lg-4 ps-lg-4 mt-5 mt-lg-0">
                        ...
                        <div class="sidebar-card text-center" style="background: linear-gradient(135deg, var(--navy) 0%, #030812 100%); color: white; border: none;">
                            ...
                            <a href="index.php#contact" class="btn btn-light rounded-pill px-4 py-2 mt-2 fw-bold" style="color: var(--navy);">Get Free Audit</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php else: ?>
        <section class="section-padding text-center" style="padding: 180px 0 120px;">
            <div class="container">
                ...
                <a href="index.php#blog" class="btn-glow text-white text-decoration-none px-5 py-3 rounded-pill d-inline-block">
                    <i class="fas fa-arrow-left me-2"></i> Go to Homepage
                </a>
            </div>
        </section>
    <?php endif; ?>
    ...
    <!-- FOOTER -->
    <footer class="footer" style="background: var(--navy); padding: 40px 0; text-align: center;">
        <div class="container">
            <img src="assets/logo.png" alt="Generation Marketing" style="max-height: 40px; filter: brightness(0) invert(1); margin-bottom: 15px;">
            <p style="color: rgba(255,255,255,0.7); margin: 0;">Grow. Scale. Succeed. &copy; 2026 Generation Marketing.</p>
        </div>
    </footer>
