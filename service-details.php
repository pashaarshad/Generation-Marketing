...
<head>
    ...
    <title>Service Details | Generation Marketing</title>
    ...
    <style>
        ...
        .nav-link.text-dark { color: var(--navy) !important; font-weight: 600; }
        .nav-link.text-dark:hover { color: var(--primary) !important; }
    </style>
</head>
<body>
    <!-- Fixed Navbar -->
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="details-poster">
                        <img id="servicePoster" src="" alt="Service Poster">
                    </div>
                </div>
                <div class="col-lg-7 details-content ps-lg-5">
                    <h1 id="serviceTitle">Loading Service...</h1>
                    <div class="price-box">
                        <h3 id="servicePrice">₹0 <span></span></h3>
                    </div>
                    <p class="lead mb-4" id="serviceDesc" style="color: var(--gray); font-size: 1.15rem; line-height: 1.6;"></p>
                    
                    <h4 class="mb-3" style="color: var(--navy);">What's Included:</h4>
                    <ul class="feature-list" id="serviceFeatures">
                        <!-- Features generated by JS -->
                    </ul>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="card border-0 shadow-sm rounded-4 p-4 p-lg-5 bg-light" style="border: 1px solid rgba(0,0,0,0.05) !important;">
                        ...
                        <p id="serviceLongDesc" style="color: var(--gray); font-size: 1.05rem; line-height: 1.8;"></p>
    ...
    <!-- FOOTER -->
    <footer class="footer mt-5" style="background: var(--navy); padding: 40px 0; text-align: center;">
        <div class="container">
            <img src="assets/logo.png" alt="Generation Marketing" style="max-height: 40px; filter: brightness(0) invert(1); margin-bottom: 15px;">
            <p style="color: rgba(255,255,255,0.7); margin: 0;">Grow. Scale. Succeed. © 2026 Generation Marketing.</p>
        </div>
    </footer>
    ...
    <script>
        const servicesData = {
            'google-ads-package': {
                ...
                longDesc: 'Our Google Ads Package is designed for businesses looking for immediate visibility and lead generation. We handle everything from keyword research and ad copy creation to continuous optimization and A/B testing. We focus on reducing your cost-per-acquisition (CPA) while maximizing conversion rates.',
                features: ['3-5 Campaigns (Search, Display, Performance Max)', 'Advanced Keyword Research & Negative Keywords', 'Competitor Analysis & Ad Copywriting', 'Conversion Tracking & Analytics Setup', 'Remarketing Campaigns Setup', 'Weekly Optimization & Transparent Reporting']
            },
            'meta-ad-package': {
                ...
                features: ['4-6 Campaigns (Lead Generation or Sales)', '10 Professional Creatives (Static Posts + Reels)', 'Advanced Audience Targeting & Lookalike Audiences', 'A/B Testing on Creatives and Ad Copy', 'Pixel Setup & Custom Conversions', 'Retargeting Setup for Maximum ROI']
            },
            'seo-starter-plan': {
                ...
                features: ['Complete Website SEO Audit', '10-15 Target Keywords Research', 'On-Page SEO (Titles, Meta tags, Headings)', 'Google My Business (GMB) Setup & Optimization', '5 Basic Quality Backlinks/month', 'Monthly Progress Report']
            },
            'growth-seo-plan': {
                ...
                features: ['20-30 Target Keywords', 'Full On-Page & Technical SEO Optimization', '10-15 High-Quality Backlinks/month', 'Competitor SEO Analysis', 'Content Strategy & Recommendations', 'Weekly Reporting & Strategy Calls']
            },
            'pro-seo-plan': {
                title: 'Pro SEO Plan',
                ...
                features: ['40-60 Target Keywords', 'Complete Website & E-commerce SEO', '20-30 Premium Quality Backlinks/month', 'Blog Content Writing & Optimization', 'Advanced Schema Markup Implementation', 'Dedicated Account Manager & Weekly Optimization']
            },
            'premium-brand-system': {
                title: 'Premium Brand System',
                price: '₹35,000', period: 'one-time',
                ...
                features: ['Custom Logo Design (3 Concepts)', 'Comprehensive Brand Strategy & Guidelines', 'Typography & Color Palette Selection', 'Social Media Kit (Profile, Cover, Post Templates)', 'Business Stationery (Cards, Letterhead, Envelope)', 'Product Packaging/Mockup Designs']
            },
            'growth-website-plan': {
                title: 'Growth Website Plan',
                price: '₹15,000', period: 'one-time',
                ...
                features: ['Premium UI/UX Design (5-8 Pages)', 'Mobile & Tablet Responsive Layout', 'Basic On-Page SEO Setup', 'Blog Section & Google Analytics Integration', 'WhatsApp Floating Button & Contact Forms', '1 Month Free Technical Support']
            },
            'ecommerce-website-setup': {
                title: 'E-Commerce Store Setup',
                price: '₹30,000', period: 'one-time',
                ...
                features: ['Shopify or WooCommerce Setup', 'Premium Theme Customization', 'Payment Gateway & Shipping Integration', 'Up to 50 Product Uploads + SEO', 'Setup of 10 Initial Ad Campaigns (Google/Meta)', 'Post-Launch Handover Training']
            },
            'starter-marketplace-setup': {
                title: 'Starter Marketplace Setup',
                price: '₹8,000', period: 'one-time',
                ...
                features: ['Seller Account Setup (Amazon, Flipkart, Meesho)', '5-30 Product Listings Upload', 'Product SEO & Keyword Optimization', 'A+ Content/Cataloging Guidance', 'Initial Sponsored Ads Setup', 'Marketplace Growth Training']
            },
            'ecommerce-management-plan': {
                title: 'E-Commerce Management',
                price: '₹5,000', period: '/month per platform',
                ...
                features: ['Daily Account Management & Health Check', 'Continuous Listing & SEO Optimization', 'Sponsored Ads Setup & Daily Management', 'Inventory Updates & Promotion Planning', 'Competitor Pricing Analysis', 'Monthly Performance Reports']
            },
            'smm-basic-package': {
                ...
                features: ['12 Posts per Month (Graphics + Reels)', 'Professional Post Design', 'Engaging Caption Writing & Hashtags', 'Management of 1 Platform (IG or FB)', 'Basic Post Scheduling', 'Monthly Progress Report']
            },
            'smm-standard-package': {
                ...
                features: ['20 Posts per Month (Graphics + Reels + Stories)', 'Premium Design & Video Editing', 'Advanced Growth Strategy & Content Calendar', 'Management of 2 Platforms (IG + FB)', 'Community Engagement', 'Monthly Insights & Strategy Call']
            },
            'smm-premium-package': {
                ...
                features: ['30 Posts per Month (Daily Content)', 'Full Account Handling & DM Management', 'Brand Strategy & Influencer Outreach Guidance', 'Management of 2+ Platforms', 'High-Quality Custom Graphics & Reel Editing', 'Priority Support & Bi-Weekly Strategy Calls']
            }
        };
        ...
        if (serviceId && servicesData[serviceId]) {
            ...
            document.title = data.title + " | Generation Marketing";
            document.getElementById('serviceTitle').textContent = data.title;
            document.getElementById('servicePrice').innerHTML = `${data.price} <span>${data.period}</span>`;
            document.getElementById('serviceDesc').textContent = data.desc;
            document.getElementById('serviceLongDesc').textContent = data.longDesc;
            document.getElementById('servicePoster').src = `Services-posters/${serviceId}.jpeg`;

            const featuresList = document.getElementById('serviceFeatures');
            data.features.forEach(feature => {
                const li = document.createElement('li');
                li.innerHTML = `<i class="fas fa-check-circle mt-1"></i> <span style="color: var(--navy); font-weight: 500;">${feature}</span>`;
                featuresList.appendChild(li);
            });
        } else {
            document.getElementById('serviceTitle').textContent = "Service Not Found";
            document.getElementById('serviceDesc').textContent = "Please go back and select a valid service.";
            document.getElementById('servicePrice').style.display = 'none';
            document.getElementById('servicePoster').style.display = 'none';
        }
    </script>
</body>
</html>
