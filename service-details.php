 ...
 */
$page_title = "Service Details | Generation Marketing";
$page_desc = "Get in-depth insights into our specialized marketing packages. Learn about deliverables, pricing, and campaign processes.";
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-lg-7 details-content ps-lg-5">
                ...
                <div class="d-flex flex-wrap gap-3 mt-5">
                    <a href="contact.php" class="btn-glow text-white text-decoration-none px-5 py-3 rounded-pill">
