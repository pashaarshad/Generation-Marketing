...
<head>
    ...
    <title>Add New Blog | Generation Marketing</title>
    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-content">
            <div class="dashboard-header">
                <div>
                    <h2>Add New Blog</h2>
                    <p class="text-muted mb-0">Create and publish a new article to the website</p>
                </div>
            </div>
            ...
            <div class="content-card">
                <form action="add-blog.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="e.g. 5 Reasons Your Business Needs Google Ads in 2026" required value="<?php echo isset($_POST['title']) ? htmlspecialchars($_POST['title']) : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="category" name="category" required>
                                    ...
                                    <option value="Google Ads" <?php echo (isset($_POST['category']) && $_POST['category'] === 'Google Ads') ? 'selected' : ''; ?>>Google Ads</option>
                                    <option value="SEO" <?php echo (isset($_POST['category']) && $_POST['category'] === 'SEO') ? 'selected' : ''; ?>>SEO</option>
                                    <option value="Meta Ads" <?php echo (isset($_POST['category']) && $_POST['category'] === 'Meta Ads') ? 'selected' : ''; ?>>Meta Ads</option>
                                    <option value="Social Media" <?php echo (isset($_POST['category']) && $_POST['category'] === 'Social Media') ? 'selected' : ''; ?>>Social Media</option>
                                    <option value="Branding" <?php echo (isset($_POST['category']) && $_POST['category'] === 'Branding') ? 'selected' : ''; ?>>Branding</option>
                                    <option value="E-Commerce" <?php echo (isset($_POST['category']) && $_POST['category'] === 'E-Commerce') ? 'selected' : ''; ?>>E-Commerce</option>
                                    <option value="Web & E-Com" <?php echo (isset($_POST['category']) && $_POST['category'] === 'Web & E-Com') ? 'selected' : ''; ?>>Web & E-Com</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="excerpt" name="excerpt" rows="2" placeholder="Write a brief, catchy summary of the article..." required><?php echo isset($_POST['excerpt']) ? htmlspecialchars($_POST['excerpt']) : ''; ?></textarea>
                    </div>
                    ...
                    <div class="row align-items-end mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted mt-1 d-block">Recommended size: 800x500px. JPG, PNG, WEBP formats.</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="status" name="status">
                                    <option value="published" selected>Published (Visible on site)</option>
